...
- "characters": EVERY person in the scene — a POPULATED cast (e.g. "narrator (red top, black trousers) + Gunnar the viking warrior in a blue tunic + his crew + a crowd of villagers"). Name at least 2-4 characters per scene plus background people (villagers, guards, courtiers, townsfolk, students — whatever fits) so no scene feels empty. EVERY character is FULLY DRESSED head-to-toe in a complete period outfit (tunic with trousers, robes, or a full gown, with shoes) — never bare-chested, never partial clothing. Each character's outfit is FIXED and consistent across all their scenes
