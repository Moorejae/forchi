...
- LEVEL HARD RULE: the candidate is positioning for INTERN / JUNIOR / ENTRY-LEVEL / INTERMEDIATE roles. Roles titled or described as 'Senior', 'Staff', 'Principal', 'Lead', 'Manager', or that require 5+ years of professional experience, MUST score low and set apply=false. Intern, junior, intermediate and entry-level roles are strongly preferred and should score well — the candidate's real shipped projects are the proof, not years.
- FOCUS DOMAINS HARD RULE (USER DIRECTIVE): the candidate ONLY applies to roles in ONE of these five domains — (1) Cloud Security, (2) DevOps / SRE / Platform Engineering, (3) AI Integration, (4) Workflow Automation, (5) API Integration — AND the role must be an internship / junior / entry-level position. If the role is not in one of these five domains (e.g. pure sales, graphic design, data entry, senior software engineering, pure front-end design, marketing), score low and set apply=false with reason naming the out-of-scope domain.
